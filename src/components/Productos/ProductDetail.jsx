...
export const ProductDetail = () => {
  ...
  const priceDiscount = () => {
    return (formProducto.precio - formProducto.precio * formProducto.descuento / 100)
  }
      ...
      {loading ? <LoadingSpinner /> : (<>
        <>
          <Container className="align-items-center" >
            <Row>
              <Col xs={12} md={6} className="text-center justify-content-center mb-3">
                <img 
                  src={fotos}
              ...
              <Col xs={12} md={6} className="d-flex align-items-center pd-text-principal">

                <Row className="pd-text-specifications">
                  <h1 className="text-center" style={{ color: "cyan" }}>{formProducto.nombre}</h1>
